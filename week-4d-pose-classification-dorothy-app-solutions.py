...
device = 'cpu'
model_path = 'pose_classifier.pt'
classes = ['pose 1', 'pose 2', 'pose 3']
...
pose_classifier = PoseClassificationMLP()
    ...
    def draw(self):
        ...
        if success:
            ...
            if results[0].keypoints != None:
                ...
                class_probs = pose_classifier(keypoint_data)
                _, pose_prediction = torch.max(class_probs, -1)
